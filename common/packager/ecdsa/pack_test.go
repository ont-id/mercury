...
//pubkey,privatekey base on ecdsa
...
//pubkey,privatekey base on sm2
func TestEncryptBaseOnSM2(t *testing.T) {
	pub := "13140387a20cafac7b3800c7119ceb2799e3658bdcd3b298a2911f466ac78c060db1ec"
	pubKey, err := hex.DecodeString(pub)
	if err != nil {
		t.Fatalf("DecodeString err:%s", err)
	}
	...
	pri := "1314d8232ab67697ac76bbd22f61f09a956a9530d1ecad2bc1c62fc10ade572291d70387a20cafac7b3800c7119ceb2799e3658bdcd3b298a2911f466ac78c060db1ec"
	priKey, err := hex.DecodeString(pri)
	if err != nil {
		t.Fatalf("DecodeString err:%s", err)
	}
