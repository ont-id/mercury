...
import (
	...
	"github.com/ont-id/mercury/cmd/did"
	http_cmd "github.com/ont-id/mercury/cmd/httpclient"
	"github.com/ont-id/mercury/common/config"
	"github.com/ont-id/mercury/common/log"
	"github.com/ont-id/mercury/common/packager/ecdsa"
	"github.com/ont-id/mercury/service"
	"github.com/ont-id/mercury/service/common"
	store "github.com/ont-id/mercury/store/leveldb"
	"github.com/ont-id/mercury/utils"
	"github.com/ont-id/mercury/vdri/ontdid"
...
func signalHandle() {
	...
	for {
		...
		case syscall.SIGQUIT, syscall.SIGTERM, syscall.SIGINT:
			log.Infof("get a signal: stop the agent mercury process:%s", si.String())
			return
		case syscall.SIGHUP:
		default:
			return
